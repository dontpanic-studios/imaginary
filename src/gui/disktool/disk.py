...
class DiskTool(QWidget):
    ...
    def initUI(self):
        ...
        self.font_button = self.label_InfoTitle.font()
        ...
        self.Input_DiskName.setFont(self.font_button)
        self.Input_DiskName.setStyleSheet("Color : white; background-color: #262626;")
        self.label_DiskName.setFont(self.font_button)
