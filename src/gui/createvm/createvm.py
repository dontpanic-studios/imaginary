...
class CreateVM(QWidget):
    ...
    def initUI(self):
        ...
        self.label_RamSize = QLabel(Language.getLanguageByEnum(LanguageList.CREATEVM_LABEL_RAM), self)
        ...
        self.Input_VMName.setFont(self.font_button)
        self.label_createVM.setFont(font_bold)
        self.label_InputLabel.setFont(self.font_button)
        self.label_InputLabel_desc.setFont(self.font_button)
        self.Input_VMDesc.setFont(self.font_button)
        self.label_loadISO.setFont(font_bold)
        self.label_loadISO_title.setFont(self.font_button)
        self.label_InputLabel_disk.setFont(self.font_button)
        self.Input_DiskSize.setFont(self.font_button)
        self.label_RamSize.setFont(self.font_button)
        self.Input_RamSize.setFont(self.font_button)
        self.label_SysType.setFont(self.font_button)
        self.experimental_HAX_Accel.setFont(self.font_button)
        self.Input_VGAMemSize.setFont(self.font_button)
        self.label_VGAMemSize.setFont(self.font_button)
        self.experimental_GPUType.setFont(self.font_button)
        self.label_GPUType.setFont(self.font_button)
        self.Input_SysCoreSize.setFont(self.font_button)
        self.experimental_Input_StartupArg.setFont(self.font_button)
        self.whybutdontcreatedisk.setFont(self.font_button)
        self.experimental_OpenGL_Accel.setFont(self.font_button)
        self.label_turnFrameBack.setFont(font_bold)
        self.diskType_VHDX.setFont(font_radio)
        self.experimental_isLegacy.setFont(self.font_button)
        self.diskType_QCOW2.setFont(font_radio)
        self.diskType_RAW.setFont(font_radio)
        self.experimental_VMType.setFont(self.font_button)
        self.label_DiskType.setFont(self.font_button)
        self.label_SysCoreSize.setFont(self.font_button)
