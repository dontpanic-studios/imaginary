...
class LanguageList(Enum): # oh no
    ...
    CREATEVM_ARGUMENT_PLACEHOLDER = auto()
    ...
    MSG_EDITVM_UNLIMITED_SETTING_ENABLED_TITLE = auto()
    MSG_EDITVM_UNLIMITED_SETTING_ENABLED_DESC = auto()
    EDITVM_DISK_NOT_SELECTED = auto()
